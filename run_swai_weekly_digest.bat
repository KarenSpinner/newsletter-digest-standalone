...
python digest_generator.py -d7 -f10 -w10 -rt 7 -s1 -nn -hs -u -v -c inputs\my_SWAI_newsletters.csv -o outputs\%dt%_digest\ -oh . -oc . -t temp\%dt%\ >logs\%dt%_SWAI_newsletter_digest_log.txt
...
python digest_generator.py -f10 -w10 -cc -v -ra -c outputs\%dt%_digest\my_SWAI_newsletters.digest7d_s1nN_a0.csv -oh outputs\%dt%_digest\SWAI_newsletter_reuse_page_collapsed.html >logs\%dt%_SWAI_newsletter_reuse_log.txt
